...
#map that fills in as violence occurs for the first time and stays filled in
for (y in seq(1996,2012)) {
...
title = paste(paste("First violence on or before ",y,sep="")," by Colombian municipality",sep="")
